...
export function MobileBottomNav() {
    ...
    // Hide Bottom Nav on Admin, Maintenance, or Banned pages
    if (pathname?.startsWith('/admin') || pathname?.startsWith('/secure-admin-login') || pathname === '/maintenance' || pathname === '/banned') {
        return null;
    }
