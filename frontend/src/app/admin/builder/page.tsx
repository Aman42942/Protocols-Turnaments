...
import { Palette, Type, Check, RefreshCw, Layers, Image as ImageIcon, Plus, Trash2, Save, LayoutTemplate, GripVertical, Eye, EyeOff, Globe } from 'lucide-react';
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="pt-6 border-t border-border">
                                    <h3 className="text-sm font-bold text-muted-foreground uppercase tracking-widest mb-4 flex items-center gap-2">
                                        <ImageIcon className="w-4 h-4" /> Social Presence & Branding
                                    </h3>
                                    <div className="grid grid-cols-1 md:grid-cols-1 gap-5">
                                        <div>
                                            <label className="text-sm font-bold flex items-center gap-2 mb-2">Social Preview Image (WhatsApp/Discord Banner)</label>
                                            <input
                                                type="text"
