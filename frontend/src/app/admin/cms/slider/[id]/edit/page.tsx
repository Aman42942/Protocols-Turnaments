        ...
        <div className="max-w-4xl mx-auto space-y-6">
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold tracking-tight">Edit Ad Slide</h1>
                        <p className="text-muted-foreground">Modify your homepage advertisement campaign.</p>
                    </div>
                </div>
                            ...
                            <CardContent className="space-y-4">
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        className="font-bold uppercase tracking-tight h-12 text-lg text-primary"
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="p-3 rounded-lg bg-muted/50 border mt-2">
                                        <span className="text-[10px] uppercase font-black tracking-widest text-muted-foreground block mb-2">Live Preview</span>
                                        {formData.mediaType === 'IMAGE' ? (
                                            <img src={formData.mediaUrl} alt="Preview" className="w-full h-32 object-cover rounded border" onError={(e) => (e.currentTarget.src = 'https://placehold.co/600x400?text=Invalid+Image+URL')} />
                                        ) : (
                                            <div className="w-full h-32 bg-black rounded border flex items-center justify-center">
